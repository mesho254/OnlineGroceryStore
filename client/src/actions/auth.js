...
import {LOGIN, LOGOUT,SIGNUP, UPDATE_WISHLIST} from "../constants/actions/authentication";
...
export const authSignup = (first_name,last_name,email,password,onSuccess,onError)=> async(dispatch)=>{
    try{
        const signupData= await api.authSignup(first_name,last_name,email,password).then(res=>res.data);
